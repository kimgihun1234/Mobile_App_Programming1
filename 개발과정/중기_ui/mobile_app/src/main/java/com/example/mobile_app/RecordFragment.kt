...
class RecordFragment : Fragment() {
    override fun onCreateView(
        ...
        val date = Date(now)
        val day = SimpleDateFormat("yyyyMMdd").format(date).toString()
        hash.put("20221125",1800)
        hash.put("20221126",3500)
        hash.put("20221127",6700)
        hash.put("20221128",8000)
        hash.put("20221129",9000)
        hash.put("20221130",3000)
        hash.put("20221209",4500)
    ...
    fun walkadd(startdate: String, enddate : String): Int{
        ...
        while( c1.compareTo( c2 ) !=1 ){
            temp = SimpleDateFormat("yyyyMMdd").format(c1.time).toString()
